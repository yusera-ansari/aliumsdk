...
final class AliumRequestManager {
    ...
    private AliumRequestManager(){

    }

    public static AliumRequestManager getManager() {
        return manager;
    }
...
boolean isSurveyPresentInLoader(String screenName){
    if (surveyLoaderMap.get(screenName)!=null)return true;
    return false;
}
void cleanup(){
...
//        }
        ...
        if(loader!=null){
            ...
            loader.stop();
            surveyLoaderMap.remove(screenName);
        }
